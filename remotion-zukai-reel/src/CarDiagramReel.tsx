...
// ▼ ナレーション音声（car-narration.m4a）の実測タイミングに合わせて確定。
//   文字起こし: public/car-narration.transcript.txt
//   各ページの開始秒 → P1:0.0 / P2:7.05 / P3:21.05 / C4:28.05 / P5:37.05 / P6:58.05 / 終:74.93
...
export const PAGE_DURATIONS: (number | null)[] = [
  ...
  292, // C4 [28.05-37.05] リスク取りたくない→安定の債券
  652, // P5 [37.05-58.05] 子育て世帯こそ計画的・米国債5%
  506, // P6 [58.05-74.93] 10年後810万・トータルで得
];
